...
func (r ReactorsApiPatchRequest) PatchReactorRequest(patchReactorRequest PatchReactorRequest) ReactorsApiPatchRequest {
	r.patchReactorRequest = &patchReactorRequest
	return r
}
...
func (a *ReactorsApiService) PatchExecute(r ReactorsApiPatchRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReactorsApiService.Patch")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.patchReactorRequest == nil {
		return nil, reportError("patchReactorRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.patchReactorRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
type ReactorsApiReactAsyncRequest struct {
	ctx               context.Context
	ApiService        *ReactorsApiService
	id                string
...
ReactAsync Method for ReactAsync
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ReactorsApiReactAsyncRequest
*/
...
func (a *ReactorsApiService) ReactAsyncExecute(r ReactorsApiReactAsyncRequest) (*ReactResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReactorsApiService.ReactAsync")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reactors/{id}/react-async"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	...
	if r.reactRequestAsync == nil {
		return localVarReturnValue, nil, reportError("reactRequestAsync is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.reactRequestAsync
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
type ReactorsApiResultGetByIdRequest struct {
	ctx        context.Context
	ApiService *ReactorsApiService
	id         string
	requestId  string
...
func (r ReactorsApiResultGetByIdRequest) Execute() (interface{}, *http.Response, error) {
	return r.ApiService.ResultGetByIdExecute(r)
}
...
ResultGetById Method for ResultGetById
	...
	@param id
	@param requestId
	@return ReactorsApiResultGetByIdRequest
*/
...
func (a *ReactorsApiService) ResultGetByIdExecute(r ReactorsApiResultGetByIdRequest) (interface{}, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReactorsApiService.ResultGetById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/reactors/{id}/results/{requestId}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
