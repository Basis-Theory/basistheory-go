...
type NullableCreateApplicationModel struct {
	value *CreateApplicationModel
	isSet bool
}

func (v NullableCreateApplicationModel) Get() *CreateApplicationModel {
	return v.value
}

func (v *NullableCreateApplicationModel) Set(val *CreateApplicationModel) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateApplicationModel) IsSet() bool {
	return v.isSet
}
...
func NewNullableCreateApplicationModel(val *CreateApplicationModel) *NullableCreateApplicationModel {
	return &NullableCreateApplicationModel{value: val, isSet: true}
}
