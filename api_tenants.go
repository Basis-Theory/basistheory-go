...
OwnerGet Method for OwnerGet
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return TenantsApiOwnerGetRequest
*/
...
func (a *TenantsApiService) OwnerGetExecute(r TenantsApiOwnerGetRequest) (*TenantMemberResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TenantsApiService.OwnerGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tenants/self/owner"
