...
func (a *BanksApiService) CreateExecute(r BanksApiCreateRequest) (*AtomicBank, *http.Response, error) {
	...
	if r.createAtomicBankRequest == nil {
		return localVarReturnValue, nil, reportError("createAtomicBankRequest is required and must be specified")
	}
...
func (a *BanksApiService) UpdateExecute(r BanksApiUpdateRequest) (*AtomicBank, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateAtomicBankRequest == nil {
		return localVarReturnValue, nil, reportError("updateAtomicBankRequest is required and must be specified")
	}
